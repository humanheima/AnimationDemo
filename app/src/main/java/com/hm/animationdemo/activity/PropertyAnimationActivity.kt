    ...
    fun onClick(view: View) {
        when (view.id) {
            R.id.btnStartRotationAnimation1 -> {
                val rotationYAnimator = ObjectAnimator.ofFloat(ivRotationY, "rotation", 0f, 180f)
                rotationYAnimator.duration = 500
                rotationYAnimator.start()
            }
            R.id.btnStartRotationAnimation2 -> {
                val rotationYAnimator = ObjectAnimator.ofFloat(ivRotationY, "rotation", 180f, 0f)
                rotationYAnimator.duration = 500
                rotationYAnimator.start()
            }
            R.id.btnTransAnimator -> {
                val infiniteAnimator =
                    ObjectAnimator.ofFloat(ll_translate_layout, "translationY", 0f, 100f)
            ...
            R.id.btnRedPacketAnimator -> {
                ...
                val rotateObjectAnimator =
                    ObjectAnimator.ofFloat(ivRedPacket, "rotation", 0f, 10f, -10f, 10f, -10f, 10f)
            ...
            R.id.btnTranslateInfinite -> {
                val mLeftAnimator = ObjectAnimator.ofFloat(
                    btnTranslateInfinite,
                    "translationX",
                    0f,
                    -100f,
                    100f,
            ...
            R.id.btn_property_value_holder -> {
                ...
                val valuesHolder = ObjectAnimator.ofPropertyValuesHolder(
                    btn_property_value_holder,
                    valuesHolder1,
                    valuesHolder2,
                    valuesHolder3
                )
            ...
            R.id.btnPropertyValueHolderOfObject -> {
                ...
                val valuesHolder1 = PropertyValuesHolder.ofObject(
                    "charText",
                    CharEvaluator(), 'A', 'Z'
                )
                val objectAnimator = ObjectAnimator.ofPropertyValuesHolder(
                    btnPropertyValueHolderOfObject,
                    valuesHolder1
                )
            ...
            R.id.btn_animation_xml -> {
                ...
                val valueAnimator = AnimatorInflater.loadAnimator(
                    this,
                    R.animator.value_animator_first
                ) as ValueAnimator
            ...
            R.id.btn_bg_animation -> {
                val colorAnimator =
                    ObjectAnimator.ofInt(btn_bg_animation, "backgroundColor", -0x7f80, -0x7f7f01)
            ...
            R.id.tv_listen_animation -> {
                val objectAnimator =
                    ObjectAnimator.ofFloat(tv_listen_animation, "scaleX", 1.0f, 2.0f)
            ...
            R.id.btn_value_animation -> {
                ...
                valueAnimator.addUpdateListener(object : ValueAnimator.AnimatorUpdateListener {
                    ...
                    override fun onAnimationUpdate(animation: ValueAnimator) {
                        ...
                        btn_value_animation.layoutParams.width =
                            mEvaluator.evaluate(fraction, btn_value_animation.width, 800)
            ...
            R.id.btn_rotate_animation -> {
                //角度大于0，是顺时针旋转
                val rotateObjectAnimator = ObjectAnimator.ofFloat(
                    ivBell,
            ...
            R.id.btnChangeText -> {
                val animChangeText = ValueAnimator.ofObject(
                    CharEvaluator(),
                    'A', 'Z'
                )
            ...
            R.id.btnAnimatorSetBuilder -> {
                ...
                val translateY =
                    ObjectAnimator.ofFloat(btnAnimatorSetBuilder, "translationY", 0f, 400f, 0f)
                val translateX =
                    ObjectAnimator.ofFloat(btnAnimatorSetBuilder, "translationX", 0f, 400f, 0f)
            ...
            R.id.btnAnimatorSetDelay -> {
                ...
                val tvTranslateY = ObjectAnimator.ofFloat(
                    btnAnimatorSetDelay,
                    "translationY", 0f, 50f, 0f
                )

                val tvTranslateX = ObjectAnimator.ofFloat(
                    btnCancelAnimatorSetBuilder,
